...
try {
    ...
    function checkGameCompletion() {
        pauseButton.textContent="checkGameCompletion"
        const rewardElement = document.querySelector('#app > div > div > div.content > div.reward');
        if (rewardElement && !gameStats.isGameOver) {
            pauseButton.textContent="checkGameCompletion22222"
    ...
    function checkAndClickPlayButton() {
        pauseButton.textContent="checkAndClickPlayButton"
        ...
        if (playButton && playButton.textContent.includes('Play')) {
            setTimeout(() => {
                pauseButton.textContent="checkAndClickPlayButton22222"
                playButton.click();
    ...
    function continuousPlayButtonCheck() {
        pauseButton.textContent="continuousPlayButtonCheck"
